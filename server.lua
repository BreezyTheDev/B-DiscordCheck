...
RegisterCommand('discordcheck', function(source, args, rawCommand) 
	...
	if IsPlayerAceAllowed(source, 'discordcheck.see') then 
		if #args == 2 then 
			...
			-- Wrong syntax, it's discordcheck <nick:name> <id> 
			TriggerClientEvent('chatMessage', source, prefix .. '^1ERROR: Wrong usage. /discordcheck <nick:name> <id>')
		end
	else 
...
-- Version Checker
expectedName = "B-DiscordCheck" -- This is the resource and is not suggested to be changed.
...
PerformHttpRequest("https://raw.githubusercontent.com/BreezyTheDev/B-DiscordCheck/main/fxmanifest.lua", function(error, res, head)
    ...
    if verFile then
        if tonumber(verFile) < resp then
            print("^1[^4" .. expectedName .. "^1] WARNING^0")
            print("^4" .. expectedName .. " ^0is outdated. Please update it from ^5https://github.com/BreezyTheDev/B-DiscordCheck^0| Current Version: ^1" .. verFile .. " ^0| New Version: ^2" .. resp .. " ^0|")
        ...
        print("^1[^4" .. expectedName .. "^1] WARNING^0")
        print("You may not have the latest version of ^4" .. expectedName .. "^0. A newer, improved version may be present at ^5https://github.com/BreezyTheDev/B-DiscordCheck^0")
    end
end)
